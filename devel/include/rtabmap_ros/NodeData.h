...
struct MD5Sum< ::rtabmap_ros::NodeData_<ContainerAllocator> >
{
  ...
  {
    return "b81c4e83abf436a4a9b6aa419b96e58f";
  }

  static const char* value(const ::rtabmap_ros::NodeData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb81c4e83abf436a4ULL;
  static const uint64_t static_value2 = 0xa9b6aa419b96e58fULL;
};
