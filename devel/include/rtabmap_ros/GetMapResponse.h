...
struct MD5Sum< ::rtabmap_ros::GetMapResponse_<ContainerAllocator> >
{
  ...
  {
    return "8e9fd34075988681e008e48663fbb30f";
  }

  static const char* value(const ::rtabmap_ros::GetMapResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8e9fd34075988681ULL;
  static const uint64_t static_value2 = 0xe008e48663fbb30fULL;
};
