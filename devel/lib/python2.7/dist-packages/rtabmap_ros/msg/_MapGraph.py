...
class MapGraph(genpy.Message):
  _md5sum = "20873aaf4e19c32bcd6517d54c1e8028"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_7d.pack(_x.mapToOdom.translation.x, _x.mapToOdom.translation.y, _x.mapToOdom.translation.z, _x.mapToOdom.rotation.x, _x.mapToOdom.rotation.y, _x.mapToOdom.rotation.z, _x.mapToOdom.rotation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mapToOdom.translation.x, _x.mapToOdom.translation.y, _x.mapToOdom.translation.z, _x.mapToOdom.rotation.x, _x.mapToOdom.rotation.y, _x.mapToOdom.rotation.z, _x.mapToOdom.rotation.w,) = _struct_7d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
