...
if("TRUE" STREQUAL "TRUE")
  set(rtabmap_ros_SOURCE_PREFIX /home/vegard/mar_project_ws/src/rtabmap_ros)
  set(rtabmap_ros_DEVEL_PREFIX /home/vegard/mar_project_ws/devel)
  ...
  set(rtabmap_ros_INSTALL_PREFIX /home/vegard/mar_project_ws/install)
...
if(NOT "/home/vegard/mar_project_ws/devel/include;/home/vegard/mar_project_ws/src/rtabmap_ros/include;/home/vegard/mar_project_ws/devel/lib/x86_64-linux-gnu/rtabmap-0.11/../../../include/rtabmap-0.11;/usr/local/include/opencv;/usr/local/include " STREQUAL " ")
  set(rtabmap_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/vegard/mar_project_ws/devel/include;/home/vegard/mar_project_ws/src/rtabmap_ros/include;/home/vegard/mar_project_ws/devel/lib/x86_64-linux-gnu/rtabmap-0.11/../../../include/rtabmap-0.11;/usr/local/include/opencv;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtabmap_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vegard/mar_project_ws/src/rtabmap_ros/${idir}'.  Ask the maintainer 'Mathieu Labbe <matlabbe@gmail.com>' to fix it.")
    endif()
    _list_append_unique(rtabmap_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rtabmap_ros;/home/vegard/mar_project_ws/devel/lib/x86_64-linux-gnu/librtabmap_core.so;/home/vegard/mar_project_ws/devel/lib/x86_64-linux-gnu/librtabmap_utilite.so;/home/vegard/mar_project_ws/devel/lib/x86_64-linux-gnu/librtabmap_gui.so;/usr/local/lib/libopencv_videostab.so.2.4.12;/usr/local/lib/libopencv_video.so.2.4.12;/usr/local/lib/libopencv_superres.so.2.4.12;/usr/local/lib/libopencv_stitching.so.2.4.12;/usr/local/lib/libopencv_photo.so.2.4.12;/usr/local/lib/libopencv_ocl.so.2.4.12;/usr/local/lib/libopencv_objdetect.so.2.4.12;/usr/local/lib/libopencv_nonfree.so.2.4.12;/usr/local/lib/libopencv_ml.so.2.4.12;/usr/local/lib/libopencv_legacy.so.2.4.12;/usr/local/lib/libopencv_imgproc.so.2.4.12;/usr/local/lib/libopencv_highgui.so.2.4.12;/usr/local/lib/libopencv_gpu.so.2.4.12;/usr/local/lib/libopencv_flann.so.2.4.12;/usr/local/lib/libopencv_features2d.so.2.4.12;/usr/local/lib/libopencv_core.so.2.4.12;/usr/local/lib/libopencv_contrib.so.2.4.12;/usr/local/lib/libopencv_calib3d.so.2.4.12")
