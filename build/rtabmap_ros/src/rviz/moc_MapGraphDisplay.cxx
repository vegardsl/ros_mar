...
static const char qt_meta_stringdata_rtabmap_ros__MapGraphDisplay[] = {
    "rtabmap_ros::MapGraphDisplay\0"
};
...
const QMetaObjectExtraData rtabmap_ros::MapGraphDisplay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rtabmap_ros::MapGraphDisplay::staticMetaObject = {
    { &MessageFilterDisplay<rtabmap_ros::MapGraph>::staticMetaObject, qt_meta_stringdata_rtabmap_ros__MapGraphDisplay,
      qt_meta_data_rtabmap_ros__MapGraphDisplay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rtabmap_ros::MapGraphDisplay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_rtabmap_ros__MapGraphDisplay))
        return static_cast<void*>(const_cast< MapGraphDisplay*>(this));
    typedef MessageFilterDisplay<rtabmap_ros::MapGraph> QMocSuperClass;
